...
router.post("/", upload.none(), validateMyRestaurantRequest, extractUserIdMiddleware, MyRestaurantController.createMyRestaurant);
router.put("/", upload.none(), extractUserIdMiddleware, validateMyRestaurantRequest, MyRestaurantController.updateMyRestaurant);
